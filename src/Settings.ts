...
export class Settings extends PluginSettingTab {
  ...
  display(): void {
    ...
    new Setting(containerEl)
      ...
      .addText(text =>
        text.setValue(this.plugin.settings.omdbApiKey).onChange(async value => {
    ...
    // Lists
    containerEl.createEl('h4', { text: 'Lists' })
  ...
  displayListContainers(containerEl: HTMLElement): void {
    this.plugin.settings.exportSettings.forEach((setting, i) => {
      ...
      listHeader.createEl('h5', { text: 'List' })
      ...
      new Setting(containerEl)
        ...
        .addSearch(search => {
          ...
          search
            .setPlaceholder('')
            .setValue(setting.targetFolderPath)
            .onChange(async value => {
      ...
      new Setting(containerEl)
        ...
        .addText(text => {
          text
            .setPlaceholder('https://www.imdb.com/list/ls523701947')
